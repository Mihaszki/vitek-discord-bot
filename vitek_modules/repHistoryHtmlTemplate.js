module.exports = {
  sendHTML: function(username, userAvatar, userId, repData, allPoints, pointsOnServer, interaction) {
    ...
    interaction.reply({ content: 'Here\'s the rep history, download and open it in a web browser:', files:  [{ attachment: Buffer.from(html, 'UTF8'), name: `rep_history_${userId}.html` }] });
  },
};